...
function DeletePdf() {
    ...
    const handleSubmit = (e) => {
        ...
        if (formValue.course && formValue.part && formValue.chapter &&
            formValue.class && formValue.pdf && deleteConfirm != null && deleteConfirm == "DELETE") {
            ...
            <form className="px-4 py-8 lg:px-0" method="post" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <div className="relative">
                            <select className="block appearance-none w-full bg-gray-200 border border-gray-700 text-black py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state" name="pdf" onChange={(e) => setFormValue({ ...formValue, pdf: e.target.value })} value={formValue.pdf} required >
                ...
                <div className="flex flex-wrap -mx-3 my-2 mt-8">
                    <div className="w-full md:w-full px-3 mb-6 md:mb-0">
                        <input className="flex cursor-pointer items-center justify-center h-12 px-6 w-full bg-blue-600 rounded font-semibold text-sm text-blue-100 hover:bg-blue-700" id="grid-first-name" type="submit" value="Delete Pdf" />
                    </div>
                </div>
            </form>
