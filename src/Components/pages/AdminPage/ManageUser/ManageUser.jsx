...
function ManageUser({ setDisapprovedUser }) {
  ...
  const grabUser = () => {
    axios
      .get(`${process.env.REACT_APP_API_DOMAIN}/user/view`, {
        headers: {
      ...
      .then((response) => {
        ...
        const disapprovedUserCount = response.data.result.filter(i => i.active != true && i.verified != true ).length
        setDisapprovedUser(disapprovedUserCount)
      })
      .catch((error) => {
        // console.log(error)
      });
  ...
  return (
    <>
      {openModal ? (
        <UserDetail setModal={setOpenModal} modalData={modalData} />
      ) : null}
            ...
            <div className="overflow-x-scroll">
              ...
              <div className="flex justify-between items-center">
                  ...
                  <div>
                    <p>
                      Non Verified User:{" "}
                      {data.filter(i => i.active != true && i.verified != true ).length}
                    </p>
                  </div>
                </div>
              </div>
                      ...
                      <tr {...headerGroup.getHeaderGroupProps()}>
                        {headerGroup.headers.map((column) => (
                          <th
                            ...
                            className="px-6 py-3 border-b-2 border-gray-300 text-left leading-4 text-blue-500 tracking-wider text-sm"
                          >
                    ...
                    {rows.map((row) => {
                      ...
                      return (
                        <tr {...row.getRowProps()}>
                          ...
                          <td
                            onClick={() => showModalFunc(row.original)}
