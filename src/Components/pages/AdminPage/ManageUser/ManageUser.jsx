...
function ManageUser() {
    ...
    const grabUser = () => {
        axios.get(`${process.env.REACT_APP_API_DOMAIN}/user/view`, {
            headers: {
                                                ...
                                                <tr {...row.getRowProps()}>
                                                    {row.cells.map(cell => {
                                                        return (
                                                            ...
                                                            ) : cell.column.id == "active" ? (<td {...cell.getCellProps()} className="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                                                                <div className="flex items-center">
                                                                    <div>
                                                                        <div className="text-sm leading-5 text-gray-800">{cell.value === true ? "Active" : "Inactive"}</div>
                                                                    </div>
                                                                </div>
                                                            </td>) :
                                                                    <td {...cell.getCellProps()} className="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
